...
<html lang="en">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <nav class="navbar navbar-expand-lg navbar-warning  bg-warning  fixed-top">
      <div class="container">
          <a class="navbar-brand" href="#"><font color='black'><b>Vendas</b></font></a>
  ...
  <a class="carousel-control-next" href="#myCarousel" data-slide="next">
    <span class="carousel-control-next-icon"></span>
          ...
          <div class="card card-outline-secondary my-4">
            ...
            <div class="card-body">
                <form method="post" action="telaVendaaS.php">
        <?php     
        ...
        ?>
           ...
           <button type="submit" class="btn btn-warning btn-lg">Vender</button>
       </form>
            </div>
          </div>
          <!-- /.card -->
